    ...
    <div class="row">
      ...
      <div class="col-md-6 p-5">
        <div class="login-container">
          <h2 class="text-center mb-4" style="margin-top:30px;font-size:40px;font-weight:bold;">Login to your account</h2>
...
<?php endif; ?>
<?php echo $__env->make('products.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HP\OneDrive\Bureau\projet\projetelbennaylaravel\samzi\resources\views/landing/login.blade.php ENDPATH**/ ?>