...
<head>
    ...
    <style>
        ...
        width: 100%;
        height: 100%;
        object-fit: cover; /* This property makes sure the aspect ratio is maintained while filling the element's content box */
    }
    </style>
...
<body>
    ...
    <nav class="navContainer position-relative " style="background-color:white">
        <div class="flex flex-wrap">
        <section class="relative mx-auto nav">
                ...
                <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="product-card">
                        <div class="card">
                            ...
                            <img class="w-100 img-fluid fixed-size" src="<?php echo e($product->image); ?>" alt="<?php echo e($product->nomProduit); ?>">
                            </div>
                            <div class="card-body text-center">
                                <p><?php echo e($product->nomProduit); ?></p>
                                <p>$<?php echo e($product->Prix); ?></p>
                                <form action="<?php echo e(url('/add_to_cart.php')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="product_id" value="<?php echo e($product->numeroProduit); ?>">
                                    <button type="submit" class="btn Buybtn btn-secondary">Add to Cart</button>
                                </form>
                            </div>
                        </div>
                    </div>
