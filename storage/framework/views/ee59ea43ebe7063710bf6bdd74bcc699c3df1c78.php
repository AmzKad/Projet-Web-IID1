                ...
                <div>
                    ...
                    <div data-aos="fade-in" data-aos-delay="2000">
                        <div class="d-md-flex justify-content-center mt-4 mb-3 my-md-5">
                            ...
                            <a href="#" class="btn btnHero btn-secondary">About us</a>
                        </div> 
                    </div>
        ...
        <div class="container">
            ...
            <div class="swiper-container overflow-visible"
                ...
                <div class="swiper-wrapper pb-5 pe-1">
                    ...
                    <div class="OurPSlide swiper-slide d-flex h-auto">
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            <span class="badge card-badge">- 45%</span>
                            <div class="card-header">
                                <div class="position-relative overflow-hidden d-block bg-light">
                            ...
                            <div class="card-body px-0 text-center">
                                <div class="d-flex justify-content-center align-items-center mx-auto mb-1">
                                    ...
                                    </div> <span class="small fw-bolder ms-2 text-muted"> 3.9 (289)</span>
                                </div>
                                <p class="mb-0 mx-2 mx-md-4 fs-p d-block text-center">Apple Blue iPhone 13 </p>
                            </div>
                        </div>
                    ...
                    <div class="OurPSlide swiper-slide d-flex h-auto">
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            <span class="badge card-badge">- 20%</span>
                            <div class="card-header">
                                <div class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="\storage\static\images\products\product-2.jpg" alt="">
                                </div>
                            ...
                            <div class="card-body px-0 text-center">
                                <div class="d-flex justify-content-center align-items-center mx-auto mb-1">
                                    ...
                                    </div> <span class="small fw-bolder ms-2 text-muted"> 4.1 (3289)</span>
                                </div>
                                <p class="mb-0 mx-2 mx-md-4 fs-p d-block text-center">Apple Blue iPhone 13 </p>
                            </div>
                        </div>
                    ...
                    <div class="OurPSlide swiper-slide d-flex h-auto">
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            <span class="badge card-badge">- 65%</span>
                            <div class="card-header">
                                <div class="position-relative overflow-hidden d-block bg-light">
                                    <img class="w-100 img-fluid position-relative z-index-10" title="" src="\storage\static\images\products\product-2.jpg" alt="">
                                </div>
                            ...
                            <div class="card-body px-0 text-center">
                                <div class="d-flex justify-content-center align-items-center mx-auto mb-1">
                                    ...
                                    </div> <span class="small fw-bolder ms-2 text-muted"> 5.0 (4289)</span>
                                </div>
                                <p class="mb-0 mx-2 mx-md-4 fs-p d-block text-center">Apple Blue iPhone 13 </p>
                            </div>
                        </div>
                        ...
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            ...
                            <div class="card-body px-0 text-center">
                                <div class="d-flex justify-content-center align-items-center mx-auto mb-1">
                                    ...
                                    </div> <span class="small fw-bolder ms-2 text-muted"> 4.2 (1289)</span>
                                </div>
                                <p class="mb-0 mx-2 mx-md-4 fs-p d-block text-center">Apple Blue iPhone 13 </p>
                            </div>
                        </div>
                        ...
                        <div class="card position-relative h-100 card-listing hover-trigger">
                            ...
                            <div class="card-body px-0 text-center">
                                <div class="d-flex justify-content-center align-items-center mx-auto mb-1">
                                    ...
                                    </div> <span class="small fw-bolder ms-2 text-muted"> 4.8 (2229)</span>
                                </div>
                                <p class="mb-0 mx-2 mx-md-4 fs-p d-block text-center">Apple Blue iPhone 13 </p>
                            </div>
                        </div>
...
</html><?php /**PATH C:\Users\HP\OneDrive\Bureau\projet bennay\projetelbennaylaravel\samzi\resources\views/landing/landpage.blade.php ENDPATH**/ ?>